...
<body>
	...
	$ten = $_GET['zilyu'];
	$one = $_GET['iti'];
	$you = $bil*1000 + $mil*100 + $ten*10 + $one;
	...
	*/
	...
	<div class="hard_number">
		<p>YOU</p>
		<li><img src="../picture/number/<?php echo $bil; ?>.png" width="100" height="100" alt=""/></li>
	...
	if($result=="clear"){ ?>
		<div class="Challenge">
		<form action="hard_end.php" method="get">
	...
	<?php } else { ?>
		<div class="Challenge">
		<form action="hard.php" method="get">
			<input type="hidden" name="result" value="<?php echo $result; ?>">
